...
- **Authentication and Authorization** — ASP.NET Identity with cookie-based sessions
- **Role-Based Access** — Admin (full CRUD) and Student (browse and enroll)
...
- **Trainees** — Admin-only management with course results and grades
- **Enrollments** — Students enroll and unenroll; view grades in personal profile
...
(Courses, Instructors, and Trainees all belong to a Department)
| Entity | Key Fields |
|--------|------------|
...
|---------|:-----:|:-------:|:-----:|
| View Instructors / Departments / Courses | Yes | Yes | Yes |
| View Instructor Salary and Address | No | No | Yes |
| Add / Edit / Delete Instructor | No | No | Yes |
| Add / Edit / Delete Department | No | No | Yes |
| Enroll in Courses | No | Yes | Yes |
| View My Courses and Profile | No | Yes | Yes |
| View and Manage Trainees | No | No | Yes |
...
| ASP.NET Core Identity | Built-in | Authentication and password hashing |
...
- **Password Hashing** — PBKDF2 with HMAC-SHA256 via ASP.NET Identity
- **SQL Injection Prevention** — EF Core parameterized queries exclusively
- **Role Guards** — Authorize attribute with Admin role on sensitive actions
- **Sensitive Data Hiding** — Salary and address hidden from non-Admin views
...
- Authentication and enrollment workflow diagrams
- Controllers and Views reference
